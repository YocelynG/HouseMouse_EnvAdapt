...
- **Step 1:** Filtering and mapping
  - Download sequencing data from SRA-NCBI
  - Clean raw reads
  - Map genomic reads
  - Recalibrate alignments and identify variants
  - Remove sex chromosomes
  - Estimate sequencing depth
  - Determine sex based on chromosome X and Y coverage

- **Step 2:** SNP calling and allele-frequency estimation
  - Evaluate sequencing and mapping quality
  - Estimate genotype likelihoods
  - Filter variants by MAF, Hardy-Weinberg equilibrium, and missingness
...
- **Step 4:** Environmental space analysis
  - Environmental variables from WorldClim
  - Environmental PCA
  - Geographic mapping of sampling localities

- **Step 5:** Genome scans for local adaptation
  - Latent Factor Mixed Models (LFMM)
  - Estimation of latent factors
  - Genomic inflation factor calibration
  - Multiple-testing correction
  - Manhattan plots

- **Step 6:** Candidate gene annotation
  - Variant Effect Predictor
  - Gene Ontology enrichment

- **Step 7:** Body-weight genome-wide association analysis
  - Variant filtering
  - GEMMA mixed-model association
  - QQ plots and Manhattan plots

- **Step 8:** Parallel evolution
  - Allele-frequency comparisons among populations
  - Identification of changes in the same direction
...
The workflow uses a combination of command-line genomic tools and R packages.
...
R version **≥ 4.1** is recommended.

R packages used throughout the analyses include:
...
---
## 🧬 2. SNP Calling and Allele Frequencies
...
---
## 🌡️ 4. Environmental Space Distribution
...
---
## 🔄 8. Parallel Evolution in Candidate Genes
